...
[^2]: La uzo de verda koloro por libroj kaj de la stelo, kiel insigno, okazis jam depost 1893, kiel simboloj de espero.
...
Kompreneble la lingvo Esperanto ne estas tute sama en 1927 kiel en 1887, kvardek jarojn antaŭe. Tamen prenu ian malnovan tekston, ekzemple la rozkoloran Duan Libron de D-ro Esperanto, presitan en Varsovio en 1888. Iu ajn Esperantisto lerninta en 1927 aŭ poste, povas ĝin legi tute flue, eĉ ne rimarkante ian diferencon, escepte la uzon de la formoj `tian`, `kian`, `nenian`, kiuj fariĝis `tiam`, `kiam`, `neniam` jam en 1889.
...
La plej gravan rolon ludis kompreneble sufiksoj kaj prefiksoj. Ilia uzo estis triobla. Unue, ili servis kiel nuraj vortfabrikiloj grandamase laŭ modelo, `vend`, `vendisto`, `vendejo`; `bona`, `malbona`; `patro`, `patrino` ktp. ŝparante lernon de apartaj radikoj. Due, ili servis kiel vivaj iloj de sentesprimo rajdantaj sur radiko kaj modifante ĝian sencon laŭvole laŭ ekzemploj `bone`, `bonege`; `kanti`, `kantaĉi`; `moki`, `moketi`, kie ili ludas kvazaŭ rolon de internaj adverboj. Trie, ili disflugis tra la lingvo per propraj flugiloj kaj kreis al si sendependan vivon kvazaŭ radikoj, vidu `ege`, `eta`, `aĵo`, `ebla`, `eble`, `aĉe`, `ulo`, `ino`, `iĝi`, `igi` ktp. Ankaŭ ili kombiniĝis inter si: `malebliĝi`, `etiĝi`, `reindigi` ktp.
